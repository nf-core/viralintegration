...
To see the the results of a test run with a full size dataset refer to the [results](https://nf-co.re/viralintegration/results) tab on the nf-core website pipeline page.

...
[![GitHub Actions CI Status](https://github.com/nf-core/viralintegration/workflows/nf-core%20CI/badge.svg)](https://github.com/nf-core/viralintegration/actions?query=workflow%3A%22nf-core+CI%22)
[![GitHub Actions Linting Status](https://github.com/nf-core/viralintegration/workflows/nf-core%20linting/badge.svg)](https://github.com/nf-core/viralintegration/actions?query=workflow%3A%22nf-core+linting%22)
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/viralintegration/results)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23viralintegration-4A154B?labelColor=000000&logo=slack)](https://nfcore.slack.com/channels/viralintegration)
...
**nf-core/viralintegration** is a bioinformatics best-practice analysis pipeline for Integration of viral sequences in genomic data.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```console
   nextflow run nf-core/viralintegration -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
The nf-core/viralintegration pipeline comes with documentation about the pipeline [usage](https://nf-co.re/viralintegration/usage), [parameters](https://nf-co.re/viralintegration/parameters) and [output](https://nf-co.re/viralintegration/output).
